...
describe('HomeComponent', () => {
        ...
        provideMockStore({
          ...
          selectors: [
            { selector: selectCurrentUserError, value: 'MockError' },
            {
              ...
              value: { isAuthenticated: true, user, errorMessage: null },
            },
          ],
        }),
        AuthService,
  ...
  it(`should inject auth service`, inject(
    [AuthService],
    async (injectService: AuthService) => {
      expect(injectService).toBe(authService);
    }
  ));

  it(`should inject user service`, inject(
    [UserService],
    async (injectService: UserService) => {
