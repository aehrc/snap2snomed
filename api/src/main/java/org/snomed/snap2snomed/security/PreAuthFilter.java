...
public class PreAuthFilter extends GenericFilterBean {
    ...
    public PreAuthFilter() {
        rules = Arrays.asList(
            ...
            new FilterRule(HttpMethod.GET, "/projects/fetch", groupValues -> webSecurity.isValidUser()),
            ...
            new FilterRule(HttpMethod.GET, "/mapView/([^\\/]+)/\\$dualMapSiblingRow", groupValues -> webSecurity.hasAnyProjectRoleForMapId(asLong(groupValues[0])) || webSecurity.isAdminUser()),
    ...
    public void doFilter(
        ...
        HttpMethod method = HttpMethod.valueOf(currentRequest.getMethod());
